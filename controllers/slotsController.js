...
function getProviderStartEnd(day, providerHours) {
    ...
    const providerStart = momentDay
        .clone()
        .add(parsedProviderHours[0][0], 'hour')
        .add(parsedProviderHours[0][1], 'minute');
    const providerEnd = momentDay
        .clone()
        .add(parsedProviderHours[1][0], 'hour')
        .add(parsedProviderHours[1][1], 'minute');
    ...
    findByProviderServiceDay: function(req, res) {
        ...
        Promise.all([
            ...
            .then(results => {
                ...
                const availableTimes = getAvailabilities(
                    day,
                    appointments,
